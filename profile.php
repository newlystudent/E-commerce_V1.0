...
?>
        ...
        <form class="profile-form" action="accntDataUpdate.php" method="post">
            <h1 style="font-size:2.5rem;font-family: 'Roboto', sans-serif;padding:1.2% 0;margin:auto;"><?php echo 'Welcome '. $_SESSION["uid"]."!"; ?></h1>
            <hr>
